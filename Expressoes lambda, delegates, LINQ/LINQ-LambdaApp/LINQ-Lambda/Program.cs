...
var r4 = products.Where(p => p.Category.Tier == 1).OrderBy(p => p.Price).ThenBy(p => p.Category.Name);
...
Console.WriteLine("FirstOrDefault test 2: " + s7);
...
Console.WriteLine("Category 1 Avarege Price: " + r13);

var r14 = products.Where(p => p.Category.Id == 5).Select(p => p.Price).DefaultIfEmpty(0.0).Average();
Console.WriteLine("Category 5 Avarege Price: " + r14);
